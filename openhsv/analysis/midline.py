...
from ..analysis.pvg import compute_pvg, get_labels, _create_maps
from pathlib import Path

_SEGNENTATION_VIDEO = Path(__file__) / Path(r"..\..\examples\segmentation.mp4")
...
if __name__ == '__main__':
    ...
    seg = io.mimread(str(_SEGNENTATION_VIDEO),
        memtest=False)
